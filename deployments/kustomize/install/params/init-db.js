const mongoHost = process.env.STOMATOLOGY_API_MONGODB_HOST
const mongoPort = process.env.STOMATOLOGY_API_MONGODB_PORT

const mongoUser = process.env.STOMATOLOGY_API_MONGODB_USERNAME
const mongoPassword = process.env.STOMATOLOGY_API_MONGODB_PASSWORD

const database = process.env.STOMATOLOGY_API_MONGODB_DATABASE
const collection = process.env.STOMATOLOGY_API_MONGODB_COLLECTION
...
let result = db[collection].insertMany([
    {
        ...
        "descriptionAppointment": [
            {
                "reasonForAppointment": "Nádcha",
                "teeths": [
                    "rhinitis"
                ]
            },
            {
                "reasonForAppointment": "Kontrola",
                "teeths": [
                    "checkup"
                ]
            }
